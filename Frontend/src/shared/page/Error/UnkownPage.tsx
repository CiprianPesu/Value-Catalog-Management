...
export default function UnknownPage404() {
    ...
    <div className='flex flex-col items-center  bg-background px-4 py-12'>
      ...
      <div className='relative z-10 flex w-full max-w-md flex-col items-center gap-8'>
        ...
        <div className='flex h-20 w-20 items-center justify-center rounded-2xl bg-card shadow-sm ring-1 ring-border'>
          <AlertCircle className='h-9 w-9 text-foreground' strokeWidth={1.5} />
        </div>

        {/* Heading area */}
        <div className='flex flex-col items-center gap-3 text-center'>
          <h1 className='text-balance text-3xl font-semibold tracking-tight text-foreground'>Pagina negăsită</h1>
        ...
        <Card className='w-full gap-0 border border-border bg-card p-0 shadow-sm'>
          ...
          >
            ...
            <div className='flex flex-col gap-0.5'>
              <span className='text-sm font-semibold text-card-foreground'>Înapoi la pagina principală</span>
              <span className='text-xs text-muted-foreground'>Navigați în siguranță înapoi pe site</span>
            </div>
            <svg
          ...
          <div className='flex items-center gap-3 px-6 py-4'>
            ...
            <p className='text-xs leading-relaxed text-muted-foreground'>
              Dacă credeți că aceasta este o eroare, vă rugăm să contactați suportul site-ului.
            </p>
          </div>
        </Card>
      </div>
