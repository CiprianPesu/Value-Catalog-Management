  ...
  return (
    <div className='flex flex-col items-center bg-background px-4 py-12'>
      ...
      <div className='pointer-events-none absolute inset-0 overflow-hidden'>
        ...
        <div className='absolute -bottom-40 left-0 h-80 w-80 rounded-full bg-2 muted opacity-60 blur-3xl' />
      </div>
      ...
      <div className='relative z-10 flex w-full max-w-md flex-col items-center gap-8'>
        ...
        <div className='flex flex-col items-center gap-3 text-center'>
          <h1 className='text-balance text-3xl font-semibold tracking-tight text-foreground'>Autentificare necesara</h1>
          <p className='max-w-xs text-pretty leading-relaxed text-muted-foreground'>
            {'Conectati-va la contul dumneavoastra pentru a accesa aplicatia.'}
          </p>
        </div>
        ...
        <Card className='w-full gap-0 border border-border bg-card p-0 shadow-sm'>
          ...
          >
            ...
            <div className='flex flex-col gap-0.5'>
              <span className='text-sm font-semibold text-card-foreground'>{'Conectare cu contul existent'}</span>
